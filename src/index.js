...
function scrollFunction() {
  ...
  //const [translation1, setTranslation1] = useState(0)
    ...
    if(document.documentElement.scrollTop > 1080) {
      ...
      document.getElementById("grid1").style.transform = 'translate(0px,'+ ((1080-document.documentElement.scrollTop)/5 +100).toString() + 'px)'
      document.getElementById("grid3").style.transform = 'translate(0px,'+ ((1080-document.documentElement.scrollTop)/5 +150).toString() + 'px)'
